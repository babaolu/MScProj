...
g_inner = gmsh.model.occ.addCircle(0, 0, 0, R_skin,
                                   angle1=theta, angle2=theta + theta_e)
g_outer = gmsh.model.occ.addCircle(0, 0, 0, R_skin + Et,
                                   angle1=theta, angle2=theta + theta_e)
...
wrapped_substrate = gmsh.model.occ.fragment(band[0],
...
gmsh.model.addPhysicalGroup(2, electrodes + [gsurf], name="Conductor_Array")
...
skin_ring = gmsh.model.occ.fragment([(2, skin)], [(2, fat)], removeObject=True,
            removeTool=False)
fat_ring = gmsh.model.occ.fragment([(2, fat)], [(2, muscle)], removeObject=True,
            removeTool=False)
muscle_ring = gmsh.model.occ.fragment([(2, muscle)], [(2, bone)],
            removeObject=True, removeTool=False)

gmsh.model.occ.synchronize()
print("Skin ring:", skin_ring)
print("Fat ring:", fat_ring)
print("Muscle ring", muscle_ring)
...
print("Fat surfaces:", fat_surfaces)
print("Muscle surfaces:", muscle_surfaces)
print("Bone surfaces:", bone_surfaces)
